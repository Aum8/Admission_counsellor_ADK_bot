...
import vertexai
from Admission_counselor.agent import root_agent
from Admission_counselor.config import Config
...
STAGING_BUCKET = f"gs://{configs.CLOUD_PROJECT}-adk-admission-counselor-staging"

AGENT_WHL_FILE = "admission_counselor-0.1.0-py3-none-any.whl"
